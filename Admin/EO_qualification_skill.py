...
class TestLogin(unittest.TestCase):
    ...
    def test_success_login(self):
        ...
        n = driver.find_element(By.ID,"menu_admin_Qualifications")
        a.move_to_element(n).perform()
        o = driver.find_element(By.ID,"menu_admin_viewSkills")
        ...
        driver.find_element(By.NAME,"skill[name]").send_keys(name)
        time.sleep(1)
        driver.find_element(By.NAME,"skill[description]").send_keys(desk)
        time.sleep(1)
